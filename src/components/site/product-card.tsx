...
export function ProductCard({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl bg-cream aspect-[4/5] shadow-luxury">
        {/* Badges */}
        ...
        <button
          ...
          className="absolute right-3 top-3 z-10 grid h-9 w-9 place-items-center rounded-full bg-white/80 text-espresso backdrop-blur-sm transition hover:bg-white hover:scale-110"
        >
